...
{
//	if ( input()->IsKeyDown( KEY_LALT ) || input()->IsKeyDown( KEY_RALT ) ) //// SLE REMOVE - fixes alt-tabbing leading to stuck roll.
//	{
//		m_bDoRoll = true;
//	}
//	else
...
CPotteryWheelPanel::CPotteryWheelPanel( vgui::Panel *pParent, const char *pName ) :
	...
	m_bParentMouseNotify(false), //// SLE NEW - backports for matsys_controls
	m_bRenderToTexture( true )
{
	...
	m_GridColor.SetColor(255, 255, 255, 255); //// SLE NEW - backports for matsys_controls
...
void CPotteryWheelPanel::DrawGrid()
{
	...
	//	meshBuilder.Color4ub( 255, 255, 255, 255 );
		meshBuilder.Color4ub(m_GridColor.r(), m_GridColor.g(), m_GridColor.b(), m_GridColor.a()); //// SLE NEW - backports for matsys_controls
