...
//-----------------------------------------------------------------------------
CParticleSystemPanelV2::CParticleSystemPanelV2( vgui::Panel *pParent, const char *pName ) : BaseClass( pParent, pName )
{
...
CParticleSystemPanelV2::~CParticleSystemPanelV2()
{
...
void CParticleSystemPanelV2::ResetView()
{
	BaseClass::ResetView();
	LookAt(SPHERE_RADIUS);
...
// Scheme
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
void CParticleSystemPanelV2::StopEffect()
{
...
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::RenderGrid( bool bEnable )
{
...
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::RenderBounds( bool bEnable )
{
...
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::RenderControlPoints( bool bEnable )
{
...
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::RenderCullBounds( bool bEnable )
{
...
// Indicates that bounds should be drawn
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::RenderHelpers( bool bEnable )
{
...
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::SetRenderedHelper( CDmeParticleFunction *pOp )
{
	if ( !pOp )
	{
		InvalidateUniqueId( &m_RenderHelperId );
...
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::OnTick()
{
	BaseClass::OnTick();
...
void CParticleSystemPanelV2::Simulate()
{
	if ( !m_pParticleSystem )
		return;
...
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::StartupParticleCollection()
{
...
void CParticleSystemPanelV2::ShutdownParticleCollection()
{
	if ( m_pParticleSystem )
	{
		if( m_bTickMyself )
...
void CParticleSystemPanelV2::SetSelfSimulation(bool bSelfSimulate )
{
...
void CParticleSystemPanelV2::SetParticleSystem( CDmeParticleSystemDefinition *pDef )
{
...
void CParticleSystemPanelV2::SetParticleSystem( const char* szParticleSystemName )
{
	ShutdownParticleCollection();
...
void CParticleSystemPanelV2::SetDmeElement( CDmeParticleSystemDefinition *pDef )
{
	SetParticleSystem( pDef );
}

CParticleCollection *CParticleSystemPanelV2::GetParticleSystem()
{
...
void CParticleSystemPanelV2::EnterManipulationMode( ManipulationMode_t manipMode, bool bMouseCapture, vgui::MouseCode mouseCode )
{
...
void CParticleSystemPanelV2::EnableAutoViewing( bool bEnable )
{
	m_bAutoView = bEnable;
	m_BestViewBoundsMin = vec3_origin;
	m_BestViewBoundsMax = vec3_origin;
...
void CParticleSystemPanelV2::UseAutoView()
{
...
// Draw bounds
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::DrawBounds()
{
	Vector vecMins, vecMaxs;
	m_pParticleSystem->GetBounds( &vecMins, &vecMaxs );
...
// Draw cull bounds
//-----------------------------------------------------------------------------
void CParticleSystemPanelV2::DrawCullBounds()
{
	Vector vecCenter;
...
void CParticleSystemPanelV2::OnPaint3D()
{
	if ( !m_pParticleSystem )
		return;
...
public:
	// constructor, destructor
	CControlPointPage( vgui::Panel *pParent, const char *pName, CParticleSystemPanelV2 *pParticleSystemPanel );
...
// Contstructor
//-----------------------------------------------------------------------------
CControlPointPage::CControlPointPage( vgui::Panel *pParent, const char *pName, CParticleSystemPanelV2 *pParticleSystemPanel ) :
...
//-----------------------------------------------------------------------------
IMPLEMENT_DMEPANEL_FACTORY( CParticleSystemPreviewPanelV2, DmeParticleSystemDefinition, "DmeParticleSystemDefinitionViewer", "Particle System Viewer", false );


//-----------------------------------------------------------------------------
// constructor, destructor
//-----------------------------------------------------------------------------
CParticleSystemPreviewPanelV2::CParticleSystemPreviewPanelV2( vgui::Panel *pParent, const char *pName ) :
	BaseClass( pParent, pName )
{
	...
	m_pParticleSystemPanel = new CParticleSystemPanelV2( pSplitterRightSide, "ParticlePreview" );
...
CParticleSystemPreviewPanelV2::~CParticleSystemPreviewPanelV2()
{
}
...
// Set the particle system to draw
//-----------------------------------------------------------------------------
void CParticleSystemPreviewPanelV2::OnThink()
{
	BaseClass::OnThink();
	CParticleCollection* pParticleSystem = m_pParticleSystemPanel->GetParticleSystem();
	if ( !pParticleSystem )
...
// Called when the particle system changes
//-----------------------------------------------------------------------------
void CParticleSystemPreviewPanelV2::OnParticleSystemReconstructed()
{
...
// Set the particle system to draw
//-----------------------------------------------------------------------------
void CParticleSystemPreviewPanelV2::SetParticleSystem( CDmeParticleSystemDefinition *pDef, bool bOverrideLock )
{
...
void CParticleSystemPreviewPanelV2::ClearParticleSystemLock()
{
	m_pLockPreview->SetSelected(false);
	m_pUnlockSystem = NULL;
}
...
void CParticleSystemPreviewPanelV2::SetDmeElement( CDmeParticleSystemDefinition *pDef )
{
...
// Indicates which helper to draw
//-----------------------------------------------------------------------------
void CParticleSystemPreviewPanelV2::SetParticleFunction( CDmeParticleFunction *pFunction )
{
...
//-----------------------------------------------------------------------------
void CParticleSystemPreviewPanelV2::OnCheckButtonChecked( KeyValues *pParams )
{
...
//-----------------------------------------------------------------------------
void CParticleSystemPreviewPanelV2::OnBackgroundColorChanged( KeyValues *pParams )
{
	m_pParticleSystemPanel->SetBackgroundColor( pParams->GetColor( "color" ) );
}

void CParticleSystemPreviewPanelV2::OnBackgroundColorPreview( KeyValues *pParams )
{
	m_pParticleSystemPanel->SetBackgroundColor( pParams->GetColor( "color" ) );
}

void CParticleSystemPreviewPanelV2::OnBackgroundColorCancel( KeyValues *pParams )
{
...
//-----------------------------------------------------------------------------
void CParticleSystemPreviewPanelV2::OnCommand( const char *pCommand )
{
