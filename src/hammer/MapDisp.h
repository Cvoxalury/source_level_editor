...
#ifdef SLE //// SLE NEW - static disp mesh, ported from Hammer-2013
#define SLE_STATIC_DISP_MESH 0 // at the moment this is incompatible with enabled bumpmaps in the editor (won't draw bumpmapped disps).
#endif
//=============================================================================
//
...
#if 1 //ndef SLE	//// SLE REMOVE: this isn't used anymore
...
#ifdef SLE
	CUtlVector<unsigned short>      m_aForcedRemoveIndices;
#endif
    // Painting Data.
