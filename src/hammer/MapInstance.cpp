...
#ifdef SLE //// SLE NEW - control to disable loading instances
		if ( Options.general.bEnableInstancesLoading )
#endif
		{
...
//-----------------------------------------------------------------------------
// Purpose: Sets the map instance's angles
...
//	BaseClass::DoTransform(matrix);
	...
	{
		char szValue[ 80 ];
#ifdef SLE //// SLE CHANGE - always round up angles to one decimal point
