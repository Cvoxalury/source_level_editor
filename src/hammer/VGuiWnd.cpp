...
IMPLEMENT_DYNAMIC(CVguiDialog, CDialog) // Hammer-2013 port
#endif
#define REPAINT_TIMER_ID	1068 //random value, hopfully no collisions	
...
#ifdef HAMMER2013_VGUIWND
		// Hammer-2013 port
		SetRepaintInterval(30); // Cannot do 16, framerate is only 40
#endif
	case WM_MOUSEWHEEL:
	case WM_KEYDOWN: 
	case WM_SYSKEYDOWN:
