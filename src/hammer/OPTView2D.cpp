...
void COPTView2D::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_ROTATECONSTRAINANGLE, m_cRotateConstrainAngle);
	if ( pDX->m_bSaveAndValidate )	// converting back
	{
		Options.view2d.iRotateConstrainAngle = m_cRotateConstrainAngle.GetCurSel();
	}
	else
	{
		m_cRotateConstrainAngle.SetCurSel(Options.view2d.iRotateConstrainAngle);
	}
#endif
...
{
#ifndef SLE //// SLE REMOVE - not sure why this option was always hidden
