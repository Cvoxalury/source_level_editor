...
#ifdef SLE //// SLE NEW: Tool textures, clips, hints, etc.
	IEditorTexture* GetToolTexture_Areaportal() { return m_pToolTexture_Areaportal; }
	IEditorTexture* GetToolTexture_Blockbullets() { return m_pToolTexture_Blockbullets; }
	IEditorTexture* GetToolTexture_BlockLight() { return m_pToolTexture_BlockLight; }
	IEditorTexture* GetToolTexture_BlockLOS() { return m_pToolTexture_BlockLOS; }
	IEditorTexture* GetToolTexture_Clip() { return m_pToolTexture_Clip; }
	IEditorTexture* GetToolTexture_Fog() { return m_pToolTexture_Fog; }
	IEditorTexture* GetToolTexture_Hint() { return m_pToolTexture_Hint; }
	IEditorTexture* GetToolTexture_Invisible() { return m_pToolTexture_Invisible; }
	IEditorTexture* GetToolTexture_InvisibleLadder() { return m_pToolTexture_InvisibleLadder; }
	IEditorTexture* GetToolTexture_NPCClip() { return m_pToolTexture_NPCClip; }
	IEditorTexture* GetToolTexture_Occluder() { return m_pToolTexture_Occluder; }
	IEditorTexture* GetToolTexture_Origin() { return m_pToolTexture_Origin; }
	IEditorTexture* GetToolTexture_PlayerClip() { return m_pToolTexture_PlayerClip; }
	IEditorTexture* GetToolTexture_Skip() { return m_pToolTexture_Skip; }
	IEditorTexture* GetToolTexture_Trigger() { return m_pToolTexture_Trigger; }
	IEditorTexture* GetToolTexture_Sky() { return m_pToolTexture_Sky; }
	IEditorTexture* GetToolTexture_Sky2D() { return m_pToolTexture_Sky2D; }
	IEditorTexture* GetToolTexture_Imposter() { return m_pToolTexture_Imposter; }
	IEditorTexture* GetToolTexture_Viscluster() { return m_pToolTexture_Viscluster; }
#endif
#endif
...
#ifdef SLE //// SLE NEW: Tool Brush Textures display toggle/filter
	// other tool brushes, clips, hints, etc
	IEditorTexture* m_pToolTexture_Areaportal;
	IEditorTexture* m_pToolTexture_Blockbullets;
	IEditorTexture* m_pToolTexture_BlockLight;
	IEditorTexture* m_pToolTexture_BlockLOS;
	IEditorTexture* m_pToolTexture_Clip;
	IEditorTexture* m_pToolTexture_Fog;
	IEditorTexture* m_pToolTexture_Hint;
	IEditorTexture* m_pToolTexture_Invisible;
	IEditorTexture* m_pToolTexture_InvisibleLadder;
	IEditorTexture* m_pToolTexture_NPCClip;
	IEditorTexture* m_pToolTexture_Occluder;
	IEditorTexture* m_pToolTexture_Origin;
	IEditorTexture* m_pToolTexture_PlayerClip;
	IEditorTexture* m_pToolTexture_Skip;
	IEditorTexture* m_pToolTexture_Trigger;
	IEditorTexture* m_pToolTexture_Sky;
	IEditorTexture* m_pToolTexture_Sky2D;
	IEditorTexture* m_pToolTexture_Imposter;
	IEditorTexture* m_pToolTexture_Viscluster;
#endif
#endif
};
