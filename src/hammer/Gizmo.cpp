...
CGizmo::CGizmo(void)
{
	...
	if (bFirst)
	{
		g_pAxisTexture = g_Textures.FindActiveTexture("Debug/debugluxelsnoalpha");//("editor/gizmoAxis");
		g_pRotateHandleTexture = g_Textures.FindActiveTexture("Debug/debugluxelsnoalpha");//("editor/gizmoRotateHandle");
		g_pScaleHandleTexture = g_Textures.FindActiveTexture("Debug/debugluxelsnoalpha");//("editor/gizmoScaleHandle");
		g_pTranslateHandleTexture = g_Textures.FindActiveTexture("Debug/debugluxelsnoalpha");//("editor/gizmoTranslateHandle");
		bFirst = false;
	}
	*/
	Initialize();
...
void CGizmo::Render(CRender3D *pRender)
{
	...
	pRender->RenderBox(Mins, Maxs, 200, 200, 200, SELECT_NONE);
	pRender->EndRenderHitTarget();
#endif
...
#ifdef SLE
int CGizmo::HitTest(CMapView *pView, const Vector2D &ptClient, bool bTestHandles)
{
