...
// Dialog Data
	...
	CSpinButtonCtrl	m_cCrossSectionSpin;
	CSpinButtonCtrl	m_cRotationArcSpin;
	CSpinButtonCtrl	m_cRotationSidesSpin;
	CSpinButtonCtrl	m_cRotationAngleSpin;
	CSpinButtonCtrl	m_cAddHeightSpin;
#endif
	//}}AFX_DATA
...
protected:
	...
	afx_msg void OnChangeCrossSection();
	afx_msg void OnChangeAddHeight();
	afx_msg void OnChangeStartAngle();
	afx_msg void OnChangeRotationAngle();
	afx_msg void OnChangeRotationSides();
#endif
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
