...
void polyMake( float x1, float  y1, float x2, float y2, int npoints, float start_ang, Vector *pmPoints, bool round = true ); //// SLE NEW - option for no rounding on solid creation
float V_rint(float);
