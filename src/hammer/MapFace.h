...
enum TextureJustification_t
{
	...
	TEXTURE_JUSTIFY_FIT_WIDTH,
	TEXTURE_JUSTIFY_FIT_HEIGHT,
	TEXTURE_JUSTIFY_FIT_025,
	TEXTURE_JUSTIFY_FIT_05,
	TEXTURE_JUSTIFY_FIT_2X2,
	TEXTURE_JUSTIFY_FIT_3X3,
	TEXTURE_JUSTIFY_FIT_4X4,
	TEXTURE_JUSTIFY_FIT_8X8,
	TEXTURE_JUSTIFY_FIT_16X16,
	TEXTURE_JUSTIFY_FIT_DEFAULT,
#endif
#ifdef SLE //// SLE NEW - randomise texture shift buttons
	TEXTURE_JUSTIFY_RANDOM_X,
	TEXTURE_JUSTIFY_RANDOM_Y,
#endif
	TEXTURE_JUSTIFY_MAX
};
...
#ifdef SLE //// SLE NEW - functions to get adjacent/neighbouring faces of this face
public:
	CMapFaceList GetAllNeighbouringFaces(CMapFaceList *in);
	void GetAllAdjacentFaces(CMapFaceList &in, CMapFaceList &out);
#endif
};
