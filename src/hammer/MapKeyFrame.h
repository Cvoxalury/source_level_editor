...
#ifdef SLE	//// SLE NEW: draw wires as true wires, with width, texture choice, subdivision...
	// this char is used to cache the texture name.
	const char *cacheTextureName;
	float cacheRopeWidth;
#endif
	enum
	{
		MAX_LINE_POINTS = 10,
