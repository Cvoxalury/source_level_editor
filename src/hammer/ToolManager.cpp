...
#include "ToolVertexEdit.h" //// renamed for clarity
...
#include "ChunkFile.h"
#ifdef SLE
#include "ToolClipper3point.h" //// SLE NEW - 3-point clipping tool, a subclass of normal Clipper
#include "ToolSprinkle.h" //// SLE NEW - sprinkle function from 2015 Hammer
#endif
...
#ifdef SLE
	AddTool( new Clipper3Point ); //// SLE NEW - 3-point clipping tool, a subclass of normal Clipper
	AddTool( new CToolEntitySprinkle); //// SLE NEW - sprinkle function from 2015 Hammer
#endif
	return true;
}
