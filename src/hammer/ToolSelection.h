...
public:
	...
	virtual bool OnLMouseDblClk2D(CMapView2D *pView, UINT nFlags, const Vector2D &vPoint);
#endif
...
#ifdef SLE
	//// SLE NEW - add context menu in 3d view
	...
	////
	//// SLE NEW: rotation pivot
	bool m_updating_rotation_pivot_bool;
#endif
