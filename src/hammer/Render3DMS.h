...
public:
	...
	bool IsDrawing3DSkybox(void);
	bool m_bDrawing3DSkybox;
#endif
	...
	void Do3DFog(CMatRenderContextPtr &pRenderContext);
	void Do3DWind(CMatRenderContextPtr &pRenderContext);
	void Do3DSnow(CMatRenderContextPtr &pRenderContext);
#endif
#ifdef SLE //// SLE NEW - 2d skybox preview
	void MakeSkyVec(float s, float t, int axis, float zFar, Vector& position, Vector2D &texCoord);
	void Draw2DSkybox(CMatRenderContextPtr &pRenderContext);
#endif
