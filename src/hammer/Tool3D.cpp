...
#ifdef SLE //// SLE NEW - half-snap enabled by Tab
	bool bDoHalfSnap = (GetKeyState(VK_TAB) & 0x8000);
#endif
	if ( !bDisableSnap )
	{
...
#ifdef SLE //// SLE NEW - half-snap enabled by Tab
	if (bDoHalfSnap) uConstraints |= constrainHalfSnap;
#endif
	return uConstraints;
}
...
#ifdef SLE //// SLE CHANGE - better visible translation plane
	pRender->SetDrawColor( Color(255,648,255) );
#else
