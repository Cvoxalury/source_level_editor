...
#ifdef SLE //// SLE NEW - soundscape browser
	void AddSoundScapeToList(const char *pSoundscape, const char *pSource);
	void AddSoundScapesFromFile(const char *pFileName);
	bool BuildSoundScapesList();
#endif
private:
