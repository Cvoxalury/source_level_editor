...
private:
	...
	void CreateMapObject( Vector &vOrigin, Vector &vSurfaceNormal, KeyValues *pSprinkleType, int nMode, bool bRandomYaw = true, bool bSurfaceAlign = false, CMapEntity *pExisting = NULL );
