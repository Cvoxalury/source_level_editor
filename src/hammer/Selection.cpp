...
#ifndef SLE //// SLE CHANGE - actually want that to happen. It really helps when going from Solids to Objects or Groups
	// and seems to work without issues at all.
...
#ifdef SLE
			if (!pObject) //// SLE NEW - fix a potential crash
				continue;
#endif
