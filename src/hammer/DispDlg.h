...
//=============================================================================
//
// Displacement Paint Geometry Dialogue
//
...
//=============================================================================
//
// Displacement Paint Alpha Dialog
//
...
#ifdef SLE //// SLE NEW - disp free drag brush
	afx_msg void OnEffectFreeDragData();
#endif
...
//=============================================================================
//
// Displacement Sculpt & Blending Dialog
//
class CSculptPushOptions;
class CSculptCarveOptions;
class CSculptProjectOptions;
#ifdef SLE //// SLE NEW: Restore 'Project' function and implement multi-texture Blending function
