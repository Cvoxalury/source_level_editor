...
#ifdef SLE //// SLE NEW - overriden to give proper origin based on total bbox of all children
void CMapGroup::GetOrigin(Vector& pfOrigin)
{
	m_BoundingBox.GetBoundsCenter(pfOrigin);
}
#endif
