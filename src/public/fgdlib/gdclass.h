...
class GDclass
{
	public:
		...
		BOOL AddVariable(GDinputvariable *pVar, GDclass *pBase, int iBaseIndex, int iVarIndex, bool allowTypeOverride = false);
...
#if 1 //def SLE // extend class for fgd
		void AppendClass(GDclass *pAppend);
#endif
		//
...
#if 1 //def SLE // extend class for fgd
		inline void SetExtendClass(bool bExtend) { m_bExtend = bExtend; }
#endif
